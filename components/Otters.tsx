...
export function OtterFlag({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 84" className={className} role="img" aria-label="Otter mascot waving a Singapore flag">
      {/* body */}
      <ellipse cx="27" cy="60" rx="15" ry="19" fill={FUR} />
      <ellipse cx="27" cy="64" rx="8.5" ry="12" fill={CREAM} />
      {/* resting left arm */}
      <path d="M16 54 Q11 60 14 68" stroke={FUR} strokeWidth="6" fill="none" strokeLinecap="round" />
      <circle cx="14" cy="68" r="4" fill={FUR_DARK} />
      {/* right arm holding the flag — this whole assembly waves */}
...
export function OtterReformer({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 64" className={className} role="img" aria-label="Otter mascot doing pilates on a reformer machine">
      {/* Fixed frame: rails, legs, footbar and springs stay put while the carriage glides. */}
      ...
      {/* Gliding carriage: the seat, shoulder rests and otter slide back and forth together. */}
      <g className="otter-reform">
...
/** Excited otter pointing to the right — "spotted a deal!" — with a little sparkle. */
export function OtterDeal({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 62 68" className={className} role="img" aria-label="Otter mascot excitedly pointing at a deal">
      {/* tail */}
      <path d="M40 58 Q54 56 50 42" stroke={FUR} strokeWidth="6" fill="none" strokeLinecap="round" />
      {/* feet */}
      <ellipse cx="20" cy="63" rx="6" ry="4" fill={FUR_DARK} />
      ...
      <circle cx="22" cy="50" r="3.5" fill={FUR_DARK} />
      {/* right arm raised, pointing up-right toward the button */}
      <path d="M38 44 Q49 40 57 33" stroke={FUR} strokeWidth="5" fill="none" strokeLinecap="round" />
      <circle cx="57" cy="33" r="3.5" fill={FUR_DARK} />
      {/* deal sparkle */}
      <path d="M57 20 l1.3 3.4 3.4 1.3 -3.4 1.3 -1.3 3.4 -1.3 -3.4 -3.4 -1.3 3.4 -1.3 z" fill={LIME} />
      {/* head */}
      <circle cx="28" cy="24" r="13" fill={FUR} />
      <circle cx="18" cy="13" r="4.5" fill={FUR_DARK} />
      <circle cx="38" cy="13" r="4.5" fill={FUR_DARK} />
      ...
      {/* open, excited mouth */}
      <ellipse cx="28" cy="26" rx="2" ry="1.4" fill={EYE} />
      <ellipse cx="28" cy="30.5" rx="2.6" ry="2.2" fill={EYE} />
      {/* raised eyebrows */}
      <path d="M18 18q4-3 8-1" stroke={LIME} strokeWidth="2" fill="none" strokeLinecap="round" />
      <path d="M30 17q4-2 8 1" stroke={LIME} strokeWidth="2" fill="none" strokeLinecap="round" />
    </svg>
  );
}
